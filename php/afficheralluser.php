...
while($user=$data->fetchObject()){
    echo "<b>nom User</b>: ".$user->nom."<br>";
    echo "<b>prenom User:</b>  ".$user->prenom."<br>";
    echo "<b>email User:</b>   ".$user->email."<br>";
    echo "<b>telphone User: </b>   ".$user->tel."<br>";
    echo "<b>mot de passe User:  </b>  ".$user->pass."<br>";
    echo"<hr>";
} 
